...
def get_postgres_data():
    request = "SELECT *, timestamp 'epoch' + CAST(timestamp AS BIGINT)/1000000 * interval '1 second' AS date_timestamp FROM blocks WHERE a.date_timestamp :: date = '%s' LIMIT 25;"%(start_date) #double check how to write this
